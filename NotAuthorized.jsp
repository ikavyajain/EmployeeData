									...
									<div class="error-container">
										<div class="well">
											...
											<h4 class="lighter smaller" style="text-aling:center;">
												<b>Sorry! You do not have access to this application.<br><br>
												Please contact IT department in case access is required.</b>
											</h4>
											<div class="space"></div>
											<hr/>
											<div class="space"></div>
											<div class="center">
												<a href="http://cor-sr-092" class="btn btn-grey">
													Go Back
												</a>
											</div>
										</div>
